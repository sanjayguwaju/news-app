  ...
  return (
    <div className="bg-white p-4">
      <div className="flex space-x-2 border-b-2 border-red-600 pb-2 mb-4">
        <div className="px-4 py-2 bg-blue-900 text-white rounded-t-lg">प्रदेश</div>
        ...
        <div className="px-4 py-2 bg-red-600 text-white rounded-t-lg">वागमती</div>
        <div className="px-4 py-2 bg-red-600 text-white rounded-t-lg">गण्डकी</div>
        <div className="px-4 py-2 bg-red-600 text-white rounded-t-lg">प्रदेश ५</div>
        <div className="px-4 py-2 bg-red-600 text-white rounded-t-lg">लुम्बिनी</div>
        <div className="px-4 py-2 bg-red-600 text-white rounded-t-lg">सुदूरपश्चिम</div>
        <div className="px-4 py-2 bg-blue-900 text-white rounded-t-lg">विचार</div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="text-zinc-700 dark:text-zinc-300 mb-4">{mainArticle.description}</p>
          <a href={mainArticle.link} className="text-blue-600 dark:text-blue-400">
            थप पढ्नुहोस्
          </a>
        </div>
