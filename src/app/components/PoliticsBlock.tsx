...
const politicsNewsData = [
  ...
  },
  {
    ...
    imgAlt: "News Image 3",
    description: "जनकपुरधाममा यौनिक तथा लैङ्गिक अल्पसंख्यकले मनाए ‘प्राइड मन्थ’",
  },
  {
  ...
  },
  {
    ...
    imgAlt: "News Image 5",
    description: "संचालनको पहिलो तीन महिनामै इन्दिरा आईभीएफ, नेपालको सफलता दर ९५%",
  },
  {
    imgSrc: "https://res.cloudinary.com/dz3facqgc/image/upload/v1719322837/ar8z0mociwdumsq585ol.jpg",
    imgAlt: "News Image 6",
        ...
        {politicsNewsData.map((news, index) => (
          <div key={index} className="overflow-hidden">
            ...
            <div className="p-4 bg-white">
              <p className="text-black text-center  text-2xl sm:text-base">{news.description}</p>
            </div>
          </div>
        ))}
      </div>
